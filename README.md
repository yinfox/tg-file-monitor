...
### v0.5.40 (2026-03-20)
- ✅ 代理设置页面补充自动填充抑制，避免浏览器把后台登录账号错误填入代理用户名/密码
- ✅ 继续保留 115 上传链路检测、日志最新优先和秒传复制策略修复

### v0.5.39 (2026-03-20)
- ✅ 修复复制过程中复检秒传时的异常处理，115 抖动不再直接导致本地复制失败
- ✅ 修复 copy_and_delete 与中途命中秒传的完成判定，115 目标目录补全失败时会回退本地同步

### v0.5.38 (2026-03-20)
- ✅ 文件同步配置页新增 115 上传链路检测按钮，可直接验证上传凭证与初始化是否可用
- ✅ 所有日志页统一为最新在上，并在打开/刷新后默认回到顶部

### v0.5.37 (2026-03-20)
- ✅ 115 秒传初始化改为走 p115client 原生上传初始化链路，减少手动 uploadinfo 带来的兼容问题
- ✅ 115 返回“请重新登录/errno=99”时改为更明确的 Cookie 失效提示

### v0.5.36 (2026-03-20)
- ✅ 代理设置改为后台左侧导航独立入口，新增专门的代理设置页面
- ✅ 代理拆分为 Telegram / HDHive-TMDB / 下载器 三类，115 保持直连

### v0.5.35 (2026-03-20)
- ✅ 自助观影公共入口移除“公开入口状态”展示，页面信息更聚焦
- ✅ 公共入口表单针对手机与桌面重新平衡布局，首屏更紧凑、桌面更协调
